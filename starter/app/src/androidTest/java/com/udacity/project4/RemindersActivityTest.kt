...
class RemindersActivityTest :
    ...
    @Test
    fun reminderScreen_addReminder_andCheckRemindersList() = runBlocking {
        // Create a reminder
    ...
    @Test
    fun saveReminderScreen_showToastMissingLocation() = runBlocking {
        // Start Tasks screen.
        val activityScenario = ActivityScenario.launch(RemindersActivity::class.java)
        dataBindingIdlingResource.monitorActivity(activityScenario)
        ...
        // Confirm that snack bar message is show
    ...
    @Test
    fun reminderScreen_addReminder_andCheckRemindersListVV() = runBlocking {
        // Start Tasks screen.
        val activityScenario = ActivityScenario.launch(RemindersActivity::class.java)
        dataBindingIdlingResource.monitorActivity(activityScenario)
